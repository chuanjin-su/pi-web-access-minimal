 ...
 *
 * Converts PDFs to Markdown. Optional cloud providers (Datalab, Gemini API)
 * are intentionally not wired up in this minimal package; unpdf is used as the
 * deterministic local extractor. A `pdf.provider` pin of "unpdf" is accepted
...
export type PDFProvider = "auto" | "unpdf";
